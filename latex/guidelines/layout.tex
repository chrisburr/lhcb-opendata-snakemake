...
\item Tables should be formatted in a simple fashion, without
  excessive use of horizontal and vertical lines. See
	\cref{tab:example} for an example. Prefer the 
	\texttt{\textbackslash{}toprule}, \texttt{\textbackslash{}midrule}, and 
	\texttt{\textbackslash{}bottomrule} commands (from the \texttt{booktabs} 
	package) over the \texttt{\textbackslash{}hline} command.
...
\begin{table}[t]
  \caption{
    ...
    Background-to-signal ratio estimated in a $\pm \SI{50}{\MeVcc}$ 
