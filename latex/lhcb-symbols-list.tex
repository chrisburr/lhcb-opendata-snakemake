...
\texttt{\textbackslash mup} & \mup & \texttt{\textbackslash mun} & \mun & \texttt{\textbackslash mupm} & \mupm \\
\texttt{\textbackslash mumu} & \mumu & \texttt{\textbackslash tauon} & \tauon & \texttt{\textbackslash taup} & \taup \\
\texttt{\textbackslash taum} & \taum & \texttt{\textbackslash taupm} & \taupm & \texttt{\textbackslash tautau} & \tautau \\
...
\texttt{\textbackslash Z} & \Z & \texttt{\textbackslash Zz} & \Zz & \texttt{\textbackslash Zg} & \Zg \\
\end{tabular*}
...
\texttt{\textbackslash Kb} & \Kb & \texttt{\textbackslash Kz} & \Kz & \texttt{\textbackslash Kzb} & \Kzb \\
...
\texttt{\textbackslash Kstarpm} & \Kstarpm & \texttt{\textbackslash Kstarmp} & \Kstarmp & \texttt{\textbackslash etaz} & \etaz \\
...
\texttt{\textbackslash Bbar} & \Bbar & \texttt{\textbackslash Bb} & \Bb & \texttt{\textbackslash BorBbar} & \BorBbar \\
\texttt{\textbackslash Bz} & \Bz & \texttt{\textbackslash Bzb} & \Bzb & \texttt{\textbackslash Bu} & \Bu \\
\texttt{\textbackslash Bub} & \Bub & \texttt{\textbackslash Bp} & \Bp & \texttt{\textbackslash Bm} & \Bm \\
\texttt{\textbackslash Bpm} & \Bpm & \texttt{\textbackslash Bmp} & \Bmp & \texttt{\textbackslash Bd} & \Bd \\
\texttt{\textbackslash Bs} & \Bs & \texttt{\textbackslash Bds} & \Bds & \texttt{\textbackslash Bsb} & \Bsb \\
...
\texttt{\textbackslash Lzz} & \Lzz & \texttt{\textbackslash Lbar} & \Lbar & \texttt{\textbackslash LorLbar} & \LorLbar \\
\texttt{\textbackslash Lambdares} & \Lambdares & \texttt{\textbackslash Lambdaresbar} & \Lambdaresbar & \texttt{\textbackslash Sigmares} & \Sigmares \\
\texttt{\textbackslash Sigmaresbar} & \Sigmaresbar & \texttt{\textbackslash Sigmaresbarz} & \Sigmaresbarz & \texttt{\textbackslash Omegares} & \Omegares \\
\texttt{\textbackslash Omegaresbar} & \Omegaresbar & \texttt{\textbackslash ppcol} & \ppcol & \texttt{\textbackslash ppbar} & \ppbar \\
...
\texttt{\textbackslash decay[2] \textbackslash decay\{\textbackslash Pa\}\{\textbackslash Pb \textbackslash Pc\}} & \decay{\Pa}{\Pb \Pc} & \texttt{\textbackslash ra} & \ra & \texttt{\textbackslash to} & \to \\
\end{tabular*}
...
\texttt{\textbackslash mBc} & \mBc & \texttt{\textbackslash mH} & \mH & \texttt{\textbackslash mLb} & \mLb \\
\texttt{\textbackslash mtquark} & \mtquark & \texttt{\textbackslash mW} & \mW & \texttt{\textbackslash mZ} & \mZ \\
\end{tabular*}
...
\subsection{Units - use the siunitx commands for typesetting}
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l}
\texttt{\textbackslash clight} & \si{\clight} & \texttt{\textbackslash micron} & \si{\micron} & \texttt{\textbackslash mrad} & \si{\mrad} \\
\texttt{\textbackslash gauss} & \si{\gauss} &  \\
\end{tabular*}

\subsubsection{Energy, momentum, mass}
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l}
\texttt{\textbackslash meV} & \si{\meV} & \texttt{\textbackslash keV} & \si{\keV} & \texttt{\textbackslash MeV} & \si{\MeV} \\
\texttt{\textbackslash GeV} & \si{\GeV} & \texttt{\textbackslash TeV} & \si{\TeV} &  \\
\end{tabular*}

\subsubsection{Cross-section and integrated luminosity}
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l}
\texttt{\textbackslash mb} & \si{\mb} & \texttt{\textbackslash nb} & \si{\nb} & \texttt{\textbackslash pb} & \si{\pb} \\
\texttt{\textbackslash fb} & \si{\fb} & \texttt{\textbackslash ab} & \si{\ab} & \texttt{\textbackslash zb} & \si{\zb} \\
\texttt{\textbackslash yb} & \si{\yb} & \texttt{\textbackslash invnb} & \si{\invnb} & \texttt{\textbackslash invpb} & \si{\invpb} \\
\texttt{\textbackslash invfb} & \si{\invfb} & \texttt{\textbackslash invab} & \si{\invab} & \texttt{\textbackslash Hzpercmsq} & \si{\Hzpercmsq} \\
\end{tabular*}

\subsubsection{Material lengths, radiation}
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l}
\texttt{\textbackslash Xrad} & \si{\Xrad} & \texttt{\textbackslash NIL} & \si{\NIL} & \texttt{\textbackslash mip} & \si{\mip} \\
...
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l@{\extracolsep{\fill}}l@{\extracolsep{0.5cm}}l}
\texttt{\textbackslash betastar} & \betastar & \texttt{\textbackslash lum} & \lum & \texttt{\textbackslash intlum[1] \textbackslash intlum\{ \textbackslash SI\{2\}\{\textbackslash invfb\} \}} & \intlum{ \SI{2}{\invfb} } \\
\end{tabular*}
